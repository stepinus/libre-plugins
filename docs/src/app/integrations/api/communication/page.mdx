...
List configured channel adapters and their status. Supports the in-process adapter set (Discord, Slack, WhatsApp, Matrix, Email, Teams, Mattermost, IRC, Google Chat, Zulip, XMPP, LINE, and more) plus sidecar channels (Telegram, ntfy, Gotify, Mastodon, Bluesky, Reddit, Twitch, Rocket.Chat, Nextcloud Talk ship as Python sidecars in `librefang-sdk`).
